 ...
 * @author DEOCCIDENTE
 */
public class CrearUsuariosInt extends javax.swing.JInternalFrame {

    /**
     * Creates new form CrearUsuariosInt
     */
    public CrearUsuariosInt() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Confirme El Password:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(new String(jPasswordField1.getPassword()).equals(new String(jPasswordField2.getPassword()))){
            ...
            try {
                ...
                JOptionPane.showMessageDialog(rootPane, "Usuario Ingresado Exitosamente");
                this.dispose();
